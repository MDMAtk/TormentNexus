...
All notable changes to HyperNexus will be documented in this file.
...
- Live demo at demo.hypernexus.site
...
- CI build output name conflicts with hypernexus/ directory
