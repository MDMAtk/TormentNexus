---
name: hypernexus
description: HyperNexus AI control plane — L2 memory, tool discovery, session import, skill registry, code search
---
...
Configure the hypernexus MCP server:
- **Command**: `C:\Users\hyper\workspace\hypernexus\hypernexus.exe`
- **Args**: `["mcp"]`

## Tools
- `mcp_hypernexus_memory_scratchpad_*` — L1 working memory
- `mcp_hypernexus_mcp_list_tools/servers` — discovery
- `mcp_hypernexus_bash/read/write/edit/grep/find/ls` — system tools
