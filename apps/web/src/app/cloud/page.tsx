			...
			<main className="max-w-7xl mx-auto px-4 py-8">
				...
				<div className="bg-gray-800 rounded-lg p-6 mb-6">
					...
					<p className="text-gray-400 mb-4">
						Connect to your HyperNexus Cloud instance using the Streamable HTTP
						transport.
					</p>
					...
					<div className="mt-4 bg-gray-700 rounded p-4">
						...
						<p className="mt-1 text-sm">
							...
							<code className="bg-gray-600 px-1 rounded">X-API-Key</code> header
							or as a <code className="bg-gray-600 px-1 rounded">Bearer</code>{" "}
