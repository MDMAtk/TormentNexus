...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider('tormentnexus.sidebar', provider));
...
class TormentNexusSidebarProvider {
    _extensionUri;
